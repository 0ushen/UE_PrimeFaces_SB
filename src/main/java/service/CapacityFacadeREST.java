...
public class CapacityFacadeREST extends AbstractFacade<Capacity> {
    ...
    public void create(Capacity entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") Integer id, Capacity entity) {
        super.edit(entity);
    }
    ...
    public Capacity find(@PathParam("id") Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public List<Capacity> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
